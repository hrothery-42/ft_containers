...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   iterator_testing_stl.cpp                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hrothery <hrothery@student.42wolfsburg.de> +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/07 10:27:39 by hrothery          #+#    #+#             */
/*   Updated: 2022/12/13 11:42:46 by hrothery         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	*it = 10; *++it= 9; *++it = 8; *++it = 7;
	...
	t_data DataSt;
	DataSt.x = 1;
	std::vector<t_data> DataVec;
	DataVec.push_back(DataSt);
	std::vector<t_data>::iterator DataIt;
	...
	it = myVec.begin();
	it2 = it + 1;
	std::vector<int>::iterator it3(it);
	...
	for (int i = 0; i < myVec.size(); i++)
		std::cout <<myVec.at(i) <<" ";
	std::cout <<std::endl;
	std::cout <<"myVec[0] = " <<myVec[0] <<", myVec[1] = " <<myVec[1] <<", myVec[2] = " <<myVec[2] <<std::endl;
